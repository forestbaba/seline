...
import PhoneVerificationWithInput from './screens/AuthScreen/PhoneVerificationWithInput';
...
import EmailAndPasswordLogin from './screens/AuthScreen/EmailAndPasswordLogin';
import ForgotPassword from './screens/AuthScreen/ForgotPassword';
import EmailAndPasswordRegister from './screens/AuthScreen/EmailAndPasswordRegister';
      ...
      <Stack.Navigator>
        ...
        {/* <Stack.Screen name="loader" options={{ headerTransparent: true, headerShown: false}}   component={LoaderScreen}></Stack.Screen> */}
        {
          loginState.userToken !== null || loginState.userToken && loginState.userToken.length > 0 ? (
            <>
              <Stack.Screen name="main" options={{ headerTransparent: true, headerShown: false }}
                title="Seline" component={Main} />
              ...
              <>
                ...
                <Stack.Screen name="Login" component={EmailAndPasswordLogin} />
                ...
                <Stack.Screen name="Register" component={EmailAndPasswordRegister} />
